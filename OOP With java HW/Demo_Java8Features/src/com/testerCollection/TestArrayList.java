...
//
//			@Override
//			public int compare(Integer o1, Integer o2) {            Imparative Type of programing
...
//			if (o1 < o2)
//				return -1;     
//			else if (o1 > o2)                                   Discreptive type of programing
//				return 1;
//			else
//				return 0;
//
//		});
		 System.out.println("\n ----Sorted List----");
		 list.forEach(no -> System.out.print(no + " "));      //Declarative type of programing

...
public class Test4 {
	...
	public static void main(String[] args) {
		...
		List<BankAccount> acts1=ArrayList<>(accounts.values());
		...
		acts.sort((a1, a2) -> ((BankAccount) a1).getCustomerName().compareTo(a2.getCustomerName()));
		System.out.println("");

		acts.forEach(a -> System.out.println(a));

		// sort by balance,id,actType
//		acts.sort((a1,a2) -> (((BankAccount) a1).getBalance())==(a2.getBalance());
//		acts.forEach(no -> System.out.println(no));

...
public class Bank {
	...
	public Bank(String fname,String lname, String email, String password, double balance, long aadharno, AccType acctype,
			LocalDate dtopen) {
		super();
		this.accno = Idcount;
		this.fname = fname;
	...
	public String toString() {
		return "Bank [accno=" + accno + ", First name=" + lname + ", Last name=" + lname+ ", email=" + email + "Aadhar Number=" + aadharno

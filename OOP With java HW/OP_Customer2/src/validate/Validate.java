...
public class Validate  {
	...
	public static String Check_email(String email,List<Customer> customerList)throws Exception_Handling{
	...
	public static Customer findByEmail(String email,List<Customer> customerList)throws Exception_Handling {
		Customer c= new Customer(email);
		int index=customerList.indexOf(c);
		if(index==-1)
			throw new Exception_Handling("Invalid id");
...
//	public static Customer validateCustomerDetails(String email, String name, String password, Double RegAmount, String DOB, Service_Plan service_plan,List<Customer> list) throws Exception_Handling {
//		Check_email(Validate_email_Name(email),list);

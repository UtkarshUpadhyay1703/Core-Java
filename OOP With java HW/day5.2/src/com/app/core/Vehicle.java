...
public class Vehicle {
	...
	public static SimpleDateFormat sdf/* sdf is refrence variable of SimpleDateFormat */;// sdf=null : static data members are inited to their def values
	static {
...
@Override
	public boolean equals(Object anotherVehicle) {
		...
		System.out.println(anotherVehicle.getClass());
